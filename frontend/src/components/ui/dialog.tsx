...
function DialogFooter({
  ...
  return (
    <div
      className={cn("flex flex-col-reverse gap-[var(--space-2)] sm:flex-row sm:justify-end", className)}
      {...props}
    />
  );
}
